...
#import "TGNoiseControl.h"
#import "../TGGUIControl.h"


@implementation TGNoiseControl
...
- (BOOL) isvisibleCtrl
{
	return [TGNoisePanel isVisible];
}

- (void) showCtrl
{
	[TGNoisePanel makeKeyAndOrderFront:nil];
}

- (void) hideCtrl
{
	[TGNoisePanel orderOut:nil];
}

- (IBAction)redraw:(id)sender
{
	[self getColor1];								// Get Color data
	[(TGGUIControl*)_parent GetNoiseData:t_data];	// Send the data to the parent
